...
class ViewShowsScreen extends StatelessWidget {
  final String roomId;final RoomModel room;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            BlocConsumer<ShowBloc, ShowState>(
                  ...
                  if (state.shows.isEmpty) {
                    ...
                    return Container(
                      decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 17, 17, 17).withOpacity(0.8),
                      ),
                                        ...
                                        onSelected: (value) {
                                          if (value == 'edit') {
                                            ...
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) =>
                                                    EditShowsScreen(roomModel:room ,
                                                  roomId: roomId,
                                                  show: shows[index],
                                                ),
                                              ),
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: ElevatedButton(
            style: ElevatedButton.styleFrom(
                backgroundColor:
                    Color.fromARGB(255, 17, 17, 17).withOpacity(0.8)),
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => AddShowsScreen(roomId: roomId,roomModel: room,)));
            },
            child: Row(
